...
; TOP ROW
Coordinates.InputField := {X: 658, Y: 31}
Coordinates.EnergyPercentButton := {X: 1071, Y: 31}
Coordinates.MagicPercentButton := {X: 1067, Y: 61}

; SIDE MENU
Coordinates.SideMenuRebirth := {X: 167, Y: 585}
...
Coordinates.Wandoos := {X: 394, Y: 414}
...
Coordinates.BloodMagicPokeYourselfDecrease := {X: 738, Y: 314}
Coordinates.BloodMagicPokeYourselfCap := {X: 805, Y: 318}

Coordinates.BloodMagicFiftyPapercutsIncrease := {X: 691, Y: 358}
Coordinates.BloodMagicFiftyPapercutsDecrease := {X: 743, Y: 367}
Coordinates.BloodMagicFiftyPapercutsCap := {X: 801, Y: 373}

; WANDOOS
Coordinates.WandoosEnergyIncrease := {X: 760, Y: 346}
Coordinates.WandoosEnergyDecrease := {X: 829, Y: 354}
Coordinates.WandoosEnergyCap := {X: 881, Y: 350}
Coordinates.WandoosMagicIncrease := {X: 789, Y: 496}
Coordinates.WandoosMagicDecrease:= {X: 820, Y: 481}
...
Coordinates.TimeMachineSpeedReduce := {X: 798, Y: 327}
Coordinates.TimeMachineMultiplierIncrease := {X: 746, Y: 459}
Coordinates.TimeMachineMultiplierReduce := {X: 796, Y: 461}

; ADVENTURE
Coordinates.AdventureSelectBox := {X: 1185, Y: 292}
Coordinates.AdventureSelectMenuFirstItem := {X: 1131, Y: 329}

; AUGMENTATION
Coordinates.AugmentationSafetyScissorsIncrease := {X: 749, Y: 366}
Coordinates.AugmentationSafetyScissorsDecrease := {X: 795, Y: 366}
Coordinates.AugmentationDangerScissorsIncrease := {X: 755, Y: 406}
Coordinates.AugmentationDangerScissorsDecrease := {X: 805, Y: 398}
...
Coordinates.RebirthChallenges := {X: 961, Y: 731}
Coordinates.RebirthChallengesBasic := {X: 575, Y: 253}
Coordinates.RebirthChallengesNoAugs := {X: 634, Y: 284}
Coordinates.RebirthYes := {X: 650, Y: 430}
Coordinates.RebirthNo := {X: 762, Y: 430}